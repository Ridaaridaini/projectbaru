...
WebUI.setText(findTestObject('Edit Employee Experience/input_company_name'), 'Q')
...
WebUI.verifyElementText(findTestObject('Edit Employee Experience/label_company_name'), 'Please enter at least 2 characters.')
