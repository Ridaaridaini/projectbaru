...
WebUI.setText(findTestObject('Edit Employee Experience/input_compay_name_modal'), 'P')
...
WebUI.verifyElementText(findTestObject('Master/label_company_name_modal'), 'Please enter at least 2 characters.')
