...
WebUI.setText(findTestObject('Edit Employee Experience/input_address'), 'jalan')

WebUI.setText(findTestObject('Edit Employee Experience/input_working_duration'), working_duration)

WebUI.verifyElementText(findTestObject('Edit Employee Experience/label_alert_address'), 'Please enter at least 7 characters.')
