...
WebUI.setText(findTestObject('Edit Employee Experience/input_compay_name_modal'), '')
...
WebUI.verifyElementText(findTestObject('new/label_This field is required'), 'This field is required.')
