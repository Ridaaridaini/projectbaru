...
WebUI.setText(findTestObject('Edit Employee Experience/input_position_modal'), 'CEO')
...
WebUI.verifyElementText(findTestObject('Edit Employee Experience/p_The position_name field must be at least 5 characters in length'), 
    'The position_name field must be at least 5 characters in length.')
