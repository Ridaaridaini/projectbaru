...
WebUI.setText(findTestObject('new/input_Contact Number_contact'), '08987898765612344544')
...
WebUI.verifyElementText(findTestObject('new/div_Email is already Exist or Check your password'), 'Email is already Exist')
