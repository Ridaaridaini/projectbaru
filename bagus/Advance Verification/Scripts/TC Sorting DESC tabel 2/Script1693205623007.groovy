...
WebUI.click(findTestObject('Sorting/Last_Name_2'))
WebUI.click(findTestObject('Sorting/Last_Name_2'))

//Ambil semua element dari last name
List<WebElement> dataList = WebUI.findWebElements(findTestObject('Object Repository/Sorting/data_list_last_name_2'), 10)
