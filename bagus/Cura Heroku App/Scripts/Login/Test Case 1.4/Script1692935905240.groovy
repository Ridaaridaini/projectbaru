...
WebUI.setText(findTestObject('Login Manual/input_Username'), '')

WebUI.setEncryptedText(findTestObject('Login Manual/input_Password'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')
