...
public class Soal3Challage {
    public static void main(String[] args) {
        ...
        if (pilihan == 1) {
            ...
            double jumlahCangkir = jumlahTeko * tekoPerCangkir;  // 1 * 25 = 25
            ...
            System.out.println(jumlahTeko + " Teko = " + jumlahBotol + " botol");
             ...
             System.out.print("Masukkan jumlah cangkir: ");
             int jumlahCangkir = scanner.nextInt();
             double jumlahCangkir2= (jumlahCangkir/tekoPerCangkir);
