...
response = WS.sendRequest(findTestObject('Object Repository/Get All Post By USERID API'))

WS.verifyResponseStatusCode(response, 200)

WS.getElementsCount(response, "")
...
for(int i = 0;i<5;i++) {
	...
	assert id != null && userId !=""
	assert title != null && userId !=""
	assert body != null && userId !=""
}
