...
WebUI.callTestCase(findTestCase('Login/Test Case 1.1(Manual)'), [('username') : GlobalVariable.username, ('password') : GlobalVariable.password], 
...
if (hospital_readmission.toString().equalsIgnoreCase('yes')) {
    WebUI.check(findTestObject('Object Repository/Make Appointment/Checkbox_Apply for hospital readmission'))
}
...
hasilReadmission = WebUI.getText(findTestObject('Object Repository/Make Appointment/Hasil Hospital Readmission'))
hasilHealthcare = WebUI.getText(findTestObject('Object Repository/Make Appointment/hasil healthcare program'))
hasilVisitDate = WebUI.getText(findTestObject('Object Repository/Make Appointment/Hasil visit date'))
hasilComment = WebUI.getText(findTestObject('Object Repository/Make Appointment/hasil comment'))
