...
//        }
        if (konversi1[1].equalsIgnoreCase("botol")){
            if (konversi1[4].equalsIgnoreCase("teko")){
                ...
                angka = angka * 0.2;
                System.out.println(konversi1[0]+ " botol = "+ angka +" teko ");

            }else if (konversi1[4].equalsIgnoreCase("cangkir")){
                double angka = Double.parseDouble(konversi1[0]);
                angka = angka * 5;
                System.out.println(konversi1[0]+ " botol = "+ angka +" cangkir ");
            }else if (konversi1[4].equalsIgnoreCase("gelas")){
                double angka = Double.parseDouble(konversi1[0]);
                angka = angka * 2;
                System.out.println(konversi1[0]+ " botol = "+ angka +" gelas ");
            }
        }else if (konversi1[1].equalsIgnoreCase("cangkir")){
            if (konversi1[4].equalsIgnoreCase("teko")){
                double angka = Double.parseDouble(konversi1[0]);
                angka = angka * 0.04;
                System.out.println(konversi1[0]+ " cangkir = "+ angka +" teko ");

            }else if (konversi1[4].equalsIgnoreCase("botol")){
                double angka = Double.parseDouble(konversi1[0]);
                angka = angka * 0.2;
                System.out.println(konversi1[0]+ " cangkir = "+ angka +" botol ");
            }else if (konversi1[4].equalsIgnoreCase("gelas")){
                double angka = Double.parseDouble(konversi1[0]);
                angka = angka * 0.4;
                System.out.println(konversi1[0]+ " cangkir = "+ angka +" gelas ");
            }
        }else if (konversi1[1].equalsIgnoreCase("gelas")){
            if (konversi1[4].equalsIgnoreCase("teko")){
                double angka = Double.parseDouble(konversi1[0]);
                angka = angka * 0.1;
                System.out.println( konversi1[0]+" gelas = "+ angka +" teko ");
            }else if (konversi1[4].equalsIgnoreCase("cangkir")){
                double angka = Double.parseDouble(konversi1[0]);
                angka = angka * 2.5;
                System.out.println(konversi1[0]+ " gelas = "+ angka +" cangkir ");
            }else if (konversi1[4].equalsIgnoreCase("botol")){
                double angka = Double.parseDouble(konversi1[0]);
                //double angka1 = Double.parseDouble(konversi1[3]);
                angka = angka * 0.5;
                System.out.println(konversi1[0]+ " gelas = "+ angka +" botol ");
            }
        }else if (konversi1[1].equalsIgnoreCase("teko")){
            if (konversi1[4].equalsIgnoreCase("botol")){
                double angka = Double.parseDouble(konversi1[0]);
                angka = angka * 10.0;
                System.out.println(konversi1[0] + " teko = "+ angka +" botol ");
            }else if (konversi1[4].equalsIgnoreCase("cangkir")){
                double angka = Double.parseDouble(konversi1[0]);
                angka = angka * 25.0;
                System.out.println(konversi1[0]+ " teko = "+ angka +" cangkir ");
            }else if (konversi1[4].equalsIgnoreCase("gelas")){
                double angka = Double.parseDouble(konversi1[0]);
                angka = angka * 5.0;
                System.out.println(konversi1[0]+" teko = "+ angka +" gelas ");
            }
        }
    }
}
