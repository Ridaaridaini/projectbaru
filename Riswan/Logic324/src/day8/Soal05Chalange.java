...
//        System.out.println(jumlahOrang);
        ...
        if(jmlOrg>5 && jmlOrg % 2==1 && lakiDewasa>perempuanDewasa){
            porsi = (lakiDewasa*2) +(lakiDewasa) +(perempuanDewasa*2)+balita+remaja+(anak/2);
            System.out.println(porsi +" porsi");
        } else if (jmlOrg>5 && jmlOrg % 2==1) {
            porsi = (lakiDewasa*2) +(perempuanDewasa*2)+balita+remaja+(anak/2);
            System.out.println(porsi +" porsi");
        } else if (lakiDewasa>perempuanDewasa) {
            porsi = (lakiDewasa*2)+lakiDewasa + perempuanDewasa+balita+remaja+(anak/2);
            System.out.println(porsi +" porsi");
        } else {
