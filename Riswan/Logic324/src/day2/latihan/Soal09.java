...
public class Soal09 {
    public static void main(String[] args) {
        ...
        System.out.println("pilih Keranjang Kertama:");
        ...
        if(pilih1 == 1 && pilih2 == 2 || pilih1 == 2 && pilih2 == 1){
            jumlah = hasil - isiKeranjang3;
        } else if (pilih1 == 1 && pilih2 == 3 || pilih1 == 3 && pilih2 == 1) {
            jumlah = hasil - isiKeranjang2;
        } else if (pilih1 == 3 && pilih2 == 2 || pilih1 == 2 && pilih2 == 3) {
