...
WebUI.verifyElementPresent(findTestObject('chekout/step 1 Checkout Your Information'), 3)
...
WebUI.verifyElementText(findTestObject('chekout/Error minta input First Name'), 'Error: Last Name is required')
