...
WebUI.callTestCase(findTestCase('4. keranjang/TC-Cart-Show-003'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('chekout/button_Cancel (your Information)'))
