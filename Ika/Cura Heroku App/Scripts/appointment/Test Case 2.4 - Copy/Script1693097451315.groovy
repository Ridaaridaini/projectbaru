...
WebUI.setText(findTestObject('make_appointment/tanggal booking'), '26/08/2023')

WebUI.setText(findTestObject('make_appointment/comment'), 'Hello world')
...
hasilReadmission = WebUI.getText(findTestObject('Object Repository/make_appointment/hasil hospital readmission'))
hasilProgram = WebUI.getText(findTestObject('Object Repository/make_appointment/hasil healthcare program'))
hasilVisit = WebUI.getText(findTestObject('Object Repository/make_appointment/hasil tanggal dipilih'))
hasilComment = WebUI.getText(findTestObject('Object Repository/make_appointment/hasil comment'))
