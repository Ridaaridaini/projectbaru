...
public class soal06Challange {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        Random random = new Random();


        System.out.print("apakah anda akan bermain (Y atau N) : ");
        String bermain = scanner.nextLine();

        while (bermain.equalsIgnoreCase("y")){
