...
WebUI.click(findTestObject('sorting/Last Name 1'))

//Ambil semua element dari last name
List<WebElement> dataList = WebUI.findWebElements(findTestObject('Object Repository/sorting/data list nama 1'), 10)
