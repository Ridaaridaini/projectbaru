...
WebUI.setText(findTestObject('login/input__username'), 'KetidakPastian')

WebUI.click(findTestObject('Object Repository/login/button_'))

//membuat objek web driver
WebDriver webDriver = DriverFactory.getWebDriver();

//mengamblik objek inputan passwordnya dulu
...
error_message = ((JavascriptExecutor) webDriver)
	.executeScript("return arguments[0].validationMessage", field_Password);
