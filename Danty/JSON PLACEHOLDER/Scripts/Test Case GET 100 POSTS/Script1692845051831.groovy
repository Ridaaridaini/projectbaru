...
//Panggil API GET 100 POSTS
response = WS.sendRequest(findTestObject('Object Repository/GET 100 POST API'))

//Verifikasi reponse code 200
WS.verifyResponseStatusCode(response, 200)

//Verifikasi jumlah Post
WS.verifyElementsCount(response, "", 100) //ngarahin kursor ke hasil run

//Ambil jumlah post(MISAL GAK TAU JUMLAH DATANYA)
