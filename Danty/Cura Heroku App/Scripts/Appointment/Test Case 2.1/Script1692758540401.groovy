...
WebUI.selectOptionByValue(findTestObject('Make Appointment/select dropdown'), 'Tokyo CURA Healthcare Center', false)

WebUI.check(findTestObject('Make Appointment/Check Box Readmission'))

WebUI.check(findTestObject('Make Appointment/input_Medicaid_programs'))

WebUI.setText(findTestObject('Make Appointment/input_Visit Date'), '24/08/2023')

WebUI.setText(findTestObject('Make Appointment/Comment'), 'Nice')
