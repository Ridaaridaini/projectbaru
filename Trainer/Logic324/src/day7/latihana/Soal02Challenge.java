...
public class Soal02Challenge {
    ...
    //Inputan bisa bolak balik misal Toko - Tempat 1 - Tempat 2 - Tempat 1 - Tempat 2 - Toko
    //Jika sudah pulang di toko, tujuan setelahnya tidak dibaca
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arrRute.length - 1; i++) {
            ...
            //Balik ke tempat 1
            else  if (ruteAsal.equalsIgnoreCase(tempat2) && ruteTujuan.equalsIgnoreCase(tempat1)){
                jarak = jarak + tempat1Tempat2;
            } else  if (ruteAsal.equalsIgnoreCase(tempat3) && ruteTujuan.equalsIgnoreCase(tempat1)){
                jarak = jarak + tempat1Tempat3;
            } else  if (ruteAsal.equalsIgnoreCase(tempat4) && ruteTujuan.equalsIgnoreCase(tempat1)){
                jarak = jarak + tempat1Tempat4;
            }
            //Balik ke tempat 2
            else  if (ruteAsal.equalsIgnoreCase(tempat3) && ruteTujuan.equalsIgnoreCase(tempat2)){
                jarak = jarak + tempat2Tempat3;
            } else  if (ruteAsal.equalsIgnoreCase(tempat4) && ruteTujuan.equalsIgnoreCase(tempat2)){
                jarak = jarak + tempat2Tempat4;
            }
            //Balik ke tempat 1
            else  if (ruteAsal.equalsIgnoreCase(tempat4) && ruteTujuan.equalsIgnoreCase(tempat3)){
                jarak = jarak + tempat3Tempat4;
            }
        }
