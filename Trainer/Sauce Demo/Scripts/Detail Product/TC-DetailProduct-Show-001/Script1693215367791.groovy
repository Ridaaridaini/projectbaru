...
price = WebUI.getText(findTestObject('Product Text Price Product 1'))

WebUI.click(findTestObject('Product Text Product 1'))

WebUI.verifyElementText(findTestObject('Detail Product Text Name Product 1'), name)
