...
WebUI.verifyElementPresent(findTestObject('Login Title Text'), 10)
...
WebUI.verifyElementText(findTestObject('Login Error Message'), 'Epic sadface: Username and password do not match any user in this service')
