...
WebUI.verifyElementPresent(findTestObject('Login Title Text'), 0)
...
WebUI.verifyElementText(findTestObject('Login Error Message'), 'Epic sadface: Sorry, this user has been locked out.')
