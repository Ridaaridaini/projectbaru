...
WebUI.callTestCase(findTestCase('Appointment/Test Case 2.1 - dinamis'), [('username') : 'John Doe', ('password') : 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM'
        ...
        , ('comment') : 'saya pasien', ('visit_date') : '23/08/2023'], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('history/menu_humburger'))

WebUI.click(findTestObject('history/menu_History'))

WebUI.verifyElementPresent(findTestObject('history/verify_History'), 10)
