...
WebUI.click(findTestObject('Sorting/th_Last Name_ex1'))

//Ambil semua element dari last name
List<WebElement> dataList = WebUI.findWebElements(findTestObject('Object Repository/Sorting/Data List Last Name'), 10)
