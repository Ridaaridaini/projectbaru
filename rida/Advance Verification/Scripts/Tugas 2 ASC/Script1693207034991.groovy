...
WebUI.click(findTestObject('Sorting/th_Due 1'))

List<WebElement> dataList = WebUI.findWebElements(findTestObject('Object Repository/Sorting/Data List Due 1'), 10)
...
for (int i = 0; i < dataList.size(); i++) {
	...
	Double textDouble = Double.valueOf(textt)
	
	arrLastNameOri[i] = textDouble

	arrLastNameSort[i] = textDouble
}
