...
public class Soal5 {
    public static void main(String[] args) {
        ...
        if (jumlahOrang % 2 == 0) {
            jumlahPorsi += (lakiLaki * prLakilaki) + (perempuan * prPerempuan) + (remaja * prRemaja) + (anak * prAnak)
                    + (balita * prBalita);
        } else if (jumlahOrang >= 5 && jumlahOrang % 2 == 1) {
            jumlahPorsi += (lakiLaki * prLakilaki) + (perempuan * (prPerempuan + 1)) + (remaja * prRemaja)
