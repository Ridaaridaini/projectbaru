...
response = WS.sendRequest(findTestObject('GET ALL COMMENTS by POSTID API', ["varPostId" : postId]))

WS.verifyResponseStatusCode(response, 200)

jmlComments = WS.getElementsCount(response, '')

for(int i = 0; i < jmlComments; i++) {
